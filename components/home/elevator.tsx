    ...
    <Grid container spacing={2} py={'70px'}>
      ...
      <Grid item xs={12} md={10} style={{ position: 'relative' }}>
        ...
        >
          ...
          />
          <span style={{ color: '#519E4A' }}>SerpentSwap is your companion</span> to navigating the EVM DeFi ecosystem. Swap between assets, provide liquidity using tokens or NFTs, and earn fees.
        </Typography>
      </Grid>
      <Grid item md={1}></Grid>
    </Grid>
